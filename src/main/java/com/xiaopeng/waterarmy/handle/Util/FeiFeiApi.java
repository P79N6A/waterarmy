...
public class FeiFeiApi {
    protected static String app_id = "307351";
    protected static String app_key = "+ri58BlR6Ci4kgzMzw3UrUh0cRGLFRqo";
    protected static String pd_id = "107351";
    protected static String pd_key= "nrpJNb6p8qeFXCvjknxzMdSZ9OhX5KXT";
    protected static String pred_url;

    private static FeiFeiApi instance;

    public static FeiFeiApi getInstance() {
        if (instance == null) {
            instance = new FeiFeiApi();
            instance.init(app_id, app_key,  pd_id, pd_key);
        }
        return instance;
    }
